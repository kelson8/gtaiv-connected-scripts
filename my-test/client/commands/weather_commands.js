let forceWeatherNow = natives.forceWeatherNow;
...
// TODO Does this effect all clients or just mine?
addCommandHandler("weather", function(command, text) {
    switch(text){
        case "sunny":
            forceWeatherNow(sunny);
            break;
        case "rain":
            forceWeatherNow(raining);
            break;
        case "storm":
            forceWeatherNow(thunderstorm);
            break;
        // default:
